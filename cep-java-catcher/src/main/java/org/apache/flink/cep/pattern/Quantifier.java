 ...
 * additional inner consuming strategy that is applied between accepted events in the org.apache.flink.scala.cep.pattern.
 */
public class Quantifier {
	...
	public void optional() {
		...
		checkPattern(!(consumingStrategy == ConsumingStrategy.NOT_NEXT ||
					consumingStrategy == ConsumingStrategy.NOT_FOLLOW), "NOT org.apache.flink.scala.cep.pattern cannot be optional");
	...
	public void greedy() {
		checkPattern(!(innerConsumingStrategy == ConsumingStrategy.SKIP_TILL_ANY),
			"Option not applicable to FollowedByAny org.apache.flink.scala.cep.pattern");
