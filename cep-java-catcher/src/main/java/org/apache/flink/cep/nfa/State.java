 ...
 * state transitions. The state transitions describe under which org.apache.flink.scala.cep.conditions it is possible to enter
 * a new state.
 */
public class State implements Serializable {
	...
	private final Collection<StateTransition> stateTransitions;
	...
	public boolean isLast() {
		return stateType == StateType.Last;
	}
	...
	public Collection<StateTransition> getStateTransitions() {
