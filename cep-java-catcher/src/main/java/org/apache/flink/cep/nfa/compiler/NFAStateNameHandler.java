 ...
 * names for the states of our {@link NFA}.
 */
public class NFAStateNameHandler {
	...
	public void checkNameUniqueness(String name) {
		if (usedNames.contains(name)) {
			throw new MalformedPatternException("Duplicate org.apache.flink.scala.cep.pattern name: " + name + ". Names must be unique.");
		}
		usedNames.add(name);
	}
	...
	/**
	 * Used to give a unique name to {@link NFA} states
