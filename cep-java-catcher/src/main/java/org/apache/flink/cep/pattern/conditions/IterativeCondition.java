 ...
 * elements in the org.apache.flink.scala.cep.pattern and decides to accept a new element or not based on some statistic over these elements.
 ...
 * the elements that belong to the org.apache.flink.scala.cep.pattern among the elements stored by the NFA. The cost of this operation can vary,
 * so when implementing your condition, try to minimize the times the method is called.
 */
public abstract class IterativeCondition implements Function, Serializable {
	 ...
	 *            the already accepted events in the org.apache.flink.scala.cep.pattern (see {@link Context#getEventsForPattern(String)}).
	 ...
	 */
	public abstract boolean filter(EventWrapper value, Context ctx) throws Exception;
	...
	public interface Context {
		 ...
		 * for a given org.apache.flink.scala.cep.pattern. Elements are iterated in the order they were
		 * inserted in the org.apache.flink.scala.cep.pattern.
		 *
		 * @param name The name of the org.apache.flink.scala.cep.pattern.
		 */
		Iterable<EventWrapper> getEventsForPattern(String name) throws Exception;
	}
}
